...
class Data:
    def __init__(self):
        ...
        mask = Image.open("./train/mask0.bmp").convert("L")
        image_new = Image.open("./train/image_new.bmp").convert("L") # Convert mask to grayscale
        mask_new = Image.open("./train/mask_new.bmp").convert("L")
